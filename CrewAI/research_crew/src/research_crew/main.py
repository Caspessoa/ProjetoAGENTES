...
def train():
    ...
    try:
        SimulacaoRecursosHidricosCrew().crew().train(n_iterations=int(sys.argv[1]), filename=sys.argv[2], inputs=inputs)
...
def replay():
    ...
    """
    try:
        SimulacaoRecursosHidricosCrew().crew().replay(task_id=sys.argv[1])
...
def test():
    ...
    try:
        SimulacaoRecursosHidricosCrew().crew().test(n_iterations=int(sys.argv[1]), eval_llm=sys.argv[2], inputs=inputs)
...
def run_with_trigger():
    ...
    try:
        result = SimulacaoRecursosHidricosCrew().crew().kickoff(inputs=inputs)
        return result
    except Exception as e:
